...
**Duration:** 2 days · **Owners:** Vaibhav Gupta (IR design), Vaibhav Gupta (CI, harness)
...
**Owner:** Vaibhav Gupta · **Est:** 5h · **Shipped:** `crates/core/src/ir.rs`
...
**Owner:** Vaibhav Gupta · **Est:** 3h · **Shipped:** `crates/core/src/diagnostic.rs`,
...
**Owner:** Vaibhav Gupta · **Est:** 5h · **Shipped:** `crates/testkit/`, `tests/integration/`
...
**Owner:** Vaibhav Gupta · **Est:** 3h · **Shipped:** `.github/workflows/ci.yml`, `xtask/`
