...
**Owner:** Vaibhav Gupta · **Est:** 3h, cut first if the phase overruns
...
- [~] P7-05 nine docs written
  - `README.md`, `docs/Quickstart.md`, `docs/SchemaReference.md`,
    `docs/QueryGuide.md`, `docs/RelationsGuide.md`,
    `docs/MigrationsGuide.md`, `docs/DialectNotes.md`,
    `docs/KnownLimitations.md`, and `docs/MigratingFrom.md` are in place.
