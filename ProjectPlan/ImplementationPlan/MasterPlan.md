...
**Team:** Claude Code (architecture, specs, review, hard algorithms) + Devin
...
Two tracks run in parallel. **Track C** = Claude (spec-first, algorithmic work).
**Track D** = Devin (implementation breadth, tests, plumbing).

| Week | Track C (Claude) | Track D (Devin) | Gate |
|---|---|---|---|
