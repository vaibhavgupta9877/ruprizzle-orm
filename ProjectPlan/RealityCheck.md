...
**Team:** Claude Code (architecture) + Devin (implementation)  
...
6. **Claude hours:** I said 10-15/week but first week needs 20+ hours just for design.
...
## Claude's Hours (Honest Allocation)
...
If you're Claude Code, you'll be working near full-time on this project. Budget accordingly.
...
| **Claude/Devin miscommunicate** | 🟠 MEDIUM | **50%** | Design docs + daily syncs | 1-2 weeks recovery |
...
## Claude + Devin: Set Realistic Expectations

**Before Week 1:**

- Devin: "This will be hard. I will get stuck. I will need Claude's help."
- Claude: "I will spend 20+ hours/week on this. It's almost full-time."
...
- [ ] Do you accept Claude works 20+ hours/week?
- [ ] Do you accept Devin will get blocked and need pivots?
...
"We built an opinionated full-stack Rust framework in 14 weeks with one developer + Claude AI. It's alpha. Not production. But it works. And it's the first time someone integrated ORM + auth + components + RPC + SSR into one cohesive stack. We proved it by building a real app with it. It's not finished, but it's real."
