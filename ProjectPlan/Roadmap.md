...
**Start:** Monday, Week 1  
**Ship:** Friday, Week 12  
**Team:** Claude Code (architecture, design docs) + Devin (implementation)  
...
### Claude's Job (10–15 hours/week)

1. **Design docs before Devin starts** (MON 9am before Devin begins)
...
3. **Weekly pivot meeting** (FRI 3pm)
   ...
   - Unblock if Devin is stuck

### Devin's Job (20–30 hours/week)
...
3. **FRI 3pm sync** with Claude + Devin (30 min)
...
**Claude's task:** Auth architecture doc (3–4 pages)
...
- Reference app: a real SaaS (auth, CRUD, multi-tenant) built in 12 weeks by one person using Claude + Devin
...
**For Devin to post MON–FRI 5pm (or whenever done):**
...
**Questions back:**
- [If need clarification from Devin]
...
- [ ] Devin has access to all design docs
- [ ] Devin has Pest tutorial link (2 hours prep)
