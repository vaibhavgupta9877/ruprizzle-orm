...
> **DRAFT — do not post until `1.0.0-rc.1` is live on crates.io.** Delete this
> banner as part of the publish commit.

**ruprizzle-orm 1.0.0-rc.1** is out. It is a schema-first ORM for
