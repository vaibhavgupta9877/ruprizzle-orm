# ruprizzle-orm 0.1.0-alpha.2

**ruprizzle-orm 0.1.0-alpha.2** is now on [crates.io](https://crates.io/crates/ruprizzle).
...
engine binary. Alpha: the API will change, and the limitations are documented.
...
I/O overhead and generated-crate cold-compile time are recorded but not yet
automated in CI.
